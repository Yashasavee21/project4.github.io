  ...
  [83],
  {
    296: function (e) {
      function t(e, t, n) {
        ...
        function i() {
          ...
          u < t && u >= 0
            ? (r = setTimeout(i, t - u))
            : ((r = null), n || ((l = e.apply(c, o)), (c = o = null)));
        }
        null == t && (t = 100);
        var u = function () {
    ...
    2083: function (e, t, n) {
      ...
      function f(e) {
        ...
        const [m, b, w] = (0, l.useMemo)(() => {
          const e = () => {
            ...
            u.current.element instanceof HTMLElement &&
              ...
              Object.freeze(f),
              v.current &&
                !h(u.current.lastBounds, f) &&
                i((u.current.lastBounds = f));
          };
        ...
        function y() {
          u.current.scrollContainers &&
            (u.current.scrollContainers.forEach((e) =>
              e.removeEventListener("scroll", w, !0)
            ),
        ...
        function g() {
          u.current.element &&
            ((u.current.resizeObserver = new c(w)),
            u.current.resizeObserver.observe(u.current.element),
            n &&
              u.current.scrollContainers &&
              u.current.scrollContainers.forEach((e) =>
                e.addEventListener("scroll", w, { capture: !0, passive: !0 })
              ));
        }
        var E, O, C;
        return (
          ...
          [
            (e) => {
              e &&
                ...
                (y(),
                (u.current.element = e),
                (u.current.scrollContainers = d(e)),
                g());
            },
            s,
            m,
      ...
      function m(e) {
        ...
        return {
          ...
          connected: void 0,
          handlers: Object.keys(v).reduce((e, n) => ({ ...e, [n]: t(n) }), {}),
          connect: (t) => {
            var n;
        ...
        return (
          L.width > 0 &&
            ...
            Z.current.configure({
              ...
              size: L,
              onPointerMissed: (...e) =>
                null == D.current ? void 0 : D.current(...e),
              onCreated: (e) => {
            ...
            Z.current.render(
              l.createElement(
                ...
                l.createElement(
                  l.Suspense,
                  { fallback: l.createElement(c.B, { set: T }) },
                  e
                )
              )
            )),
          ...
          l.createElement(
            ...
            l.createElement(
              "div",
              { ref: j, style: { width: "100%", height: "100%" } },
              l.createElement(
                "canvas",
                { ref: S, style: { display: "block" } },
                t
              )
            )
          )
      ...
      function w({ all: e, scene: t, camera: n }) {
        const r = (0, c.w)(({ gl: e }) => e),
          o = (0, c.w)(({ camera: e }) => e),
          s = (0, c.w)(({ scene: e }) => e);
        return (
          l.useLayoutEffect(() => {
            ...
            new i.CubeCamera(0.01, 1e5, l).update(r, t || s),
              l.dispose(),
              c.forEach((e) => (e.visible = !1));
          }, []),
          null
        );
      }

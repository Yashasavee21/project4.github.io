                            ...
                            switch ((n.prev = n.next)) {
                              ...
                              case 78:
                                ie || (oe = ue.asPath),
                                  ue.matchedPage &&
                                    ue.resolvedHref &&
                                    ((J = ue.resolvedHref),
                                    (Y.pathname = A.addBasePath(J)),
                                    ie || (r = R.formatWithValidation(Y))),
                                  (n.next = 84);
                                break;
                              case 82:
                                (Y.pathname = W(J, te)),
                              ...
                              case 89:
                                ...
                                if (
                                  ...
                                  (le = T.pathname),
                                  (fe = E.getRouteRegex(ce)),
                                  (se = S.getRouteMatcher(fe)(le)),
                                ...
                                if (
                                  ("route" in (ye = n.sent) &&
                                    ...
                                    b.isDynamicRoute(J) &&
                                      ...
                                      (be = E.getRouteRegex(J)),
                                      (xe = S.getRouteMatcher(be)(_e)) &&
                                        Object.assign(ee, xe))),
                                  !("type" in ye))
                                ) {
                                  n.next = 120;
                              ...
                              case 120:
                                ...
                                if (
                                  ((o.locale = !1),
                                  !(je = Se.pageProps.__N_REDIRECT).startsWith(
                                    "/"
                                  ) ||
                                    !1 === Se.pageProps.__N_REDIRECT_BASE_PATH)
                                ) {
                                  n.next = 132;
                                  break;
                                }
